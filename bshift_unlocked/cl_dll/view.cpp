...
cvar_t	*cl_waterdist;
cvar_t	*cl_chasedist;
#if defined ( BSHIFT_UNLOCKED_VIEWBOB )
cvar_t	*cl_bob_enabled;
#endif // defined ( BSHIFT_UNLOCKED_VIEWBOB )
#if defined ( BSHIFT_UNLOCKED_VIEWROLL )
cvar_t	*cl_viewroll_enabled;
cvar_t	*cl_viewroll_angle;
cvar_t	*cl_viewroll_speed;
#endif // defined ( BSHIFT_UNLOCKED_VIEWROLL )
...
#if defined ( BSHIFT_UNLOCKED_VIEWROLL )
	if (cl_viewroll_enabled->value == TRUE)
	{
		pparams->movevars->rollangle = cl_viewroll_angle->value;
		pparams->movevars->rollspeed = cl_viewroll_speed->value;
	}
#endif // defined ( BSHIFT_UNLOCKED_VIEWROLL )
...
#if defined ( BSHIFT_UNLOCKED_VIEWBOB )
	cl_bob_enabled		= gEngfuncs.pfnRegisterVariable( "cl_bob_enabled","1", 0 );
#endif // defined ( BSHIFT_UNLOCKED_VIEWBOB )
#if defined ( BSHIFT_UNLOCKED_VIEWROLL )
	cl_viewroll_enabled	= gEngfuncs.pfnRegisterVariable( "cl_viewroll_enabled","1", 0 );
	cl_viewroll_angle	= gEngfuncs.pfnRegisterVariable( "cl_viewroll_angle","2", 0 );
	cl_viewroll_speed	= gEngfuncs.pfnRegisterVariable( "cl_viewroll_speed","200", 0 );
#endif // defined ( BSHIFT_UNLOCKED_VIEWROLL )
}
