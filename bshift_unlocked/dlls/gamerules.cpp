...
// via SKILLS.CFG. Any player hivehand tuning must take place in the code. (sjb)
	...
	gSkillData.rosenbergHealth = GetSkillCvar("sk_rosenberg_health");
	gSkillData.armorVestRegen = GetSkillCvar("sk_armorvest");
	gSkillData.helmetRegen = GetSkillCvar("sk_helmet");
