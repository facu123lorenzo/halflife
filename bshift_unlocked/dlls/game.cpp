...
cvar_t	sk_rosenberg_health1 = { "sk_rosenberg_health1", "0" };
cvar_t	sk_rosenberg_health2 = { "sk_rosenberg_health2", "0" };
cvar_t	sk_rosenberg_health3 = { "sk_rosenberg_health3", "0" };

cvar_t	sk_armorvest1	= { "sk_armorvest1","0" };
cvar_t	sk_armorvest2	= { "sk_armorvest2","0" };
cvar_t	sk_armorvest3	= { "sk_armorvest3","0" };
...
#if defined ( BSHIFT_UNLOCKED_DLL )
	CVAR_REGISTER ( &sk_rosenberg_health1 );
	CVAR_REGISTER ( &sk_rosenberg_health2 );
	CVAR_REGISTER ( &sk_rosenberg_health3 );
...
#if defined ( BSHIFT_UNLOCKED_DLL )
	SERVER_COMMAND( "exec skill_bshift_unlocked.cfg\n" );
#endif // defined ( BSHIFT_UNLOCKED_DLL )
}
